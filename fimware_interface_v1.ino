 ...
 * 
 * Este arquivo é parte do projeto DMX Node Pro.
 * Licenciado sob a CC BY-NC-SA 4.0 (Uso não comercial).
 * É estritamente proibida a venda deste código ou de hardware derivado 
 * sem autorização expressa do autor.
 * Detalhes: https://creativecommons.org/licenses/by-nc-sa/4.0/
 */
